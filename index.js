...
function handleSubmissions() {
  queryTab({ type: "submission" }, function(response) {
...
async function query_ai(question) {
  const res = await fetch(`${BASE_URL}api/question`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      "x-api-key": await get_api_key()
    },
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document
    ...
    .addEventListener("click", get_site_details);
  ...
  get_api_key().then(apiKey => {
    if (apiKey) {
      document.getElementById("apiKeyInput").value = apiKey.substring(0, 3) + "*****";
      document.getElementById("apiStatus").innerText = "Valid API Key";
      document.getElementById("apiStatus").style.color = "green";
    }
  });
});
